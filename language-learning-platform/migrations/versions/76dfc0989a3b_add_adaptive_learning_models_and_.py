...
def upgrade():
    ...
    op.create_table(
        "adaptive_learning_path_progress",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("user_id", sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table("activities", schema=None) as batch_op:
        ...
        batch_op.add_column(
            sa.Column("concept_focus", sa.String(length=100), nullable=True)
        )
    ...
    with op.batch_alter_table("learning_paths", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(
            None, "proficiency_assessments", ["assessment_id"], ["id"]
        )
    ...
    with op.batch_alter_table("user_activity_logs", schema=None) as batch_op:
        ...
        batch_op.add_column(
            sa.Column("interventions_triggered", sa.JSON(), nullable=True)
        )
        batch_op.add_column(
