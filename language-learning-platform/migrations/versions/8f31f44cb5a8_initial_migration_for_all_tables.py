...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "requirements_met", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column("criteria", postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column(
            "current_progress", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "skills_mastered", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
