...
from app.models import db, User, Profile, Activity, UserActivityLog, Chapter, UserGoal, Badge, LearningPath
...
class ComprehensiveTestSuite:
    ...
    def test_database_connection(self):
        ...
        try:
            with self.app.app_context():
                ...
                self.log_test("Chapter Model", "PASS", f"- Found {chapter_count} chapters")
    ...
    def test_authentication_flow(self):
        ...
        try:
            ...
            if response.status_code in [200, 201]:
                ...
                self.log_test("User Registration", "PASS", f"- User created successfully")
                self.test_username = register_data['username']
            else:
                self.log_test("User Registration", "FAIL", f"Status: {response.status_code}, Response: {response.get_json()}")
                return False
        except Exception as e:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log_test("User Login", "PASS", f"- Token received, User ID: {self.test_user_id}")
            else:
    ...
    def test_onboarding_flow(self):
        ...
        try:
            ...
            if response.status_code == 200:
                data = response.get_json()
                self.log_test("Get Initial Assessment", "PASS", f"- {len(data.get('questions', []))} questions received")
            else:
                self.log_test("Get Initial Assessment", "FAIL", f"Status: {response.status_code}")
        except Exception as e:
        ...
        try:
            ...
            response = self.client.post('/api/onboarding/submit-assessment',
            ...
            if response.status_code in [200, 201]:
                data = response.get_json()
                self.log_test("Submit Assessment", "PASS", f"- Level: {data.get('proficiency_level', 'N/A')}")
            else:
                self.log_test("Submit Assessment", "FAIL", f"Status: {response.status_code}")
        except Exception as e:
            self.log_test("Submit Assessment", "FAIL", str(e))
        
        # Test 3: Get Recommended Learning Paths
        try:
            response = self.client.get('/api/learning-paths/recommended', headers=headers)
            if response.status_code == 200:
                data = response.get_json()
                paths = data if isinstance(data, list) else data.get('paths', [])
                self.log_test("Get Recommended Learning Paths", "PASS", f"- {len(paths)} paths found")
            else:
                self.log_test("Get Recommended Learning Paths", "FAIL", f"Status: {response.status_code}")
        except Exception as e:
    ...
    def test_goal_setting(self):
        ...
        try:
            ...
            response = self.client.post('/api/goals/create',
                                       json=goal_data,
                                       headers=headers,
                                       content_type='application/json')
            ...
            if response.status_code in [200, 201]:
                data = response.get_json()
                self.log_test("Create User Goal", "PASS", f"- Goal created: {data.get('goal', {}).get('description', 'N/A')}")
            else:
                self.log_test("Create User Goal", "FAIL", f"Status: {response.status_code}")
        except Exception as e:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log_test("Get User Goals", "FAIL", f"Status: {response.status_code}")
        except Exception as e:
    ...
    def test_activity_generation(self):
        ...
        try:
            ...
            response = self.client.post('/api/activities/generate',
            ...
            if response.status_code in [200, 201]:
                data = response.get_json()
                self.log_test("Generate Vocabulary Activity", "PASS", f"- Activity created")
            else:
                self.log_test("Generate Vocabulary Activity", "FAIL", f"Status: {response.status_code}")
        except Exception as e:
        ...
        try:
            ...
            if response.status_code in [200, 201]:
                self.log_test("Generate Grammar Activity", "PASS", f"- Activity created")
            else:
                self.log_test("Generate Grammar Activity", "FAIL", f"Status: {response.status_code}")
        except Exception as e:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log_test("Get Available Activities", "PASS", f"- {len(activities)} activities available")
            else:
                self.log_test("Get Available Activities", "FAIL", f"Status: {response.status_code}")
        except Exception as e:
    ...
    def test_personalization(self):
        ...
        try:
            response = self.client.get('/api/personalization/recommendations', headers=headers)
            if response.status_code == 200:
                data = response.get_json()
                self.log_test("Get Personalized Recommendations", "PASS", f"- Recommendations received")
            else:
                self.log_test("Get Personalized Recommendations", "FAIL", f"Status: {response.status_code}")
        except Exception as e:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log_test("Get User Progress", "FAIL", f"Status: {response.status_code}")
        except Exception as e:
            self.log_test("Get User Progress", "FAIL", str(e))
        
        # Test 3: Get Adaptive Content
        try:
            response = self.client.get('/api/adaptive-learning/next-activity', headers=headers)
            if response.status_code == 200:
                data = response.get_json()
                self.log_test("Get Adaptive Content", "PASS", f"- Next activity recommended")
            else:
                self.log_test("Get Adaptive Content", "FAIL", f"Status: {response.status_code}")
        except Exception as e:
    ...
    def test_gamification(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log_test("Get User Badges", "PASS", f"- {len(badges)} badges found")
            else:
                self.log_test("Get User Badges", "FAIL", f"Status: {response.status_code}")
        except Exception as e:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log_test("Get Leaderboard", "FAIL", f"Status: {response.status_code}")
        except Exception as e:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log_test("Get User Stats", "FAIL", f"Status: {response.status_code}")
        except Exception as e:
    ...
    def test_chat_tutor(self):
        ...
        try:
            ...
            if response.status_code in [200, 201]:
                ...
                self.log_test("Send Chat Message", "FAIL", f"Status: {response.status_code}")
        except Exception as e:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log_test("Get Chat History", "FAIL", f"Status: {response.status_code}")
        except Exception as e:
    ...
    def test_practice_sessions(self):
        ...
        try:
            ...
            response = self.client.post('/api/practice/start',
                                       json=session_data,
                                       headers=headers,
                                       content_type='application/json')
            ...
            if response.status_code in [200, 201]:
                ...
                self.log_test("Start Practice Session", "FAIL", f"Status: {response.status_code}")
        except Exception as e:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log_test("Get Practice History", "FAIL", f"Status: {response.status_code}")
        except Exception as e:
    ...
    def test_analytics(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log_test("Get Learning Analytics", "FAIL", f"Status: {response.status_code}")
        except Exception as e:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log_test("Get Performance Metrics", "FAIL", f"Status: {response.status_code}")
        except Exception as e:
