...
class APITester:
    ...
    def test_user_endpoints(self):
        ...
        settings_data = {
            ...
            "notification_settings": {"reminders": True, "achievements": True},
        }
    ...
    def test_course_endpoints(self):
        ...
        # Test start activity
        start_activity_data = {"enrollment_id": 1, "activity_id": 1}
        ...
        self.make_request(
            "POST", "/api/courses/complete-activity", complete_activity_data
        )
    ...
    def test_media_endpoints(self):
        ...
        pronunciation_data = {"target_word": "నమస్కారం", "difficulty_level": "beginner"}
        self.make_request(
            "POST", "/api/media/pronunciation-exercise", pronunciation_data
        )
