...
class Milestone(db.Model):
    ...
    # Relationship
    user = db.relationship('User', backref=db.backref('milestones', lazy='dynamic', cascade='all, delete-orphan'))
...
class LessonReview(db.Model):
    ...
    activity_log = db.relationship('UserActivityLog', backref=db.backref('review', uselist=False))
    ...
    def __repr__(self):
        return f'<LessonReview for User {self.user_id} - Activity {self.activity_log_id}>'
