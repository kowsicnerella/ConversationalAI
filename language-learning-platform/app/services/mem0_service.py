...
class Mem0Service:
    ...
    def memory(self):
        ...
        if not self._initialized:
            try:
                ...
                print(
                    "Mem0 features will be disabled. Set up Weaviate and Google AI to enable."
                )
                self._memory = None
                self._initialized = True
        return self._memory
    ...
    def add_user_interaction(
        ...
        try:
            ...
            result = self.memory.add(
                messages=message,
                user_id=str(user_id),
                metadata={**enriched_context, **(metadata or {})},
            )
    ...
    def update_user_memory(
        self, memory_id: str, user_id: int, updated_data: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
        ...
        try:
            result = self.memory.update(memory_id=memory_id, data=updated_data)
    ...
    def delete_user_memory(self, memory_id: str, user_id: int) -> Dict[str, Any]:
        """
    ...
    def get_user_context_for_conversation(
        self, user_id: int, conversation_type: str = "chat", recent_limit: int = 5
    ) -> Dict[str, Any]:
        """
    ...
    def save_vocabulary_learning(
        self, user_id: int, vocabulary_data: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
    ...
    def get_personalized_suggestions(
        ...
        try:
            ...
            weakness_search = self.search_user_memories(
                "mistakes weaknesses struggles difficult", user_id, limit=5
            )

            # Search for strengths
            strength_search = self.search_user_memories(
                "achievements strengths good performance", user_id, limit=3
            )

            # Search for interests
            interest_search = self.search_user_memories(
                "interests topics preferences likes", user_id, limit=3
            )
            ...
            return {"weaknesses": [], "strengths": [], "interests": [], "error": str(e)}
