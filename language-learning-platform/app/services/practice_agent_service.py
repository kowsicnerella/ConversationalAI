...
class PracticeAgentService:
    ...
    def generate_adaptive_practice_questions(
        self, user_id, chapter_id, num_questions=5, session_type="practice"
    ):
        """
    ...
    def _analyze_user_learning_context(self, user_id, chapter_id):
        ...
        previous_progress = (
            ...
            .order_by(UserChapterProgress.chapter_id.desc())
            .limit(5)
            .all()
        )
        ...
        recent_mistakes = (
            MistakePattern.query.filter_by(user_id=user_id, is_resolved=False)
            .order_by(MistakePattern.frequency_count.desc())
            .limit(10)
            .all()
        )
        ...
        weak_vocabulary = (
            ...
            .filter(VocabularyWord.mastery_level < 0.7)
            .order_by(VocabularyWord.mastery_level.asc())
            .limit(15)
            .all()
        )
        ...
        context["preferred_question_types"] = self._identify_preferred_question_types(
            user_id
        )
    ...
    def _calculate_adaptive_parameters(self, learning_context, chapter):
        ...
        if current_progress:
            ...
            if attempts > 0:
                if avg_score >= 0.85:
                    params["difficulty_level"] = self._increase_difficulty(
                        chapter.difficulty_level
                    )
                    params["challenge_level"] = "high"
                elif avg_score <= 0.6:
                    params["difficulty_level"] = self._decrease_difficulty(
                        chapter.difficulty_level
                    )
        ...
        params["question_distribution"]["comprehension"] = max(
            1, total_questions - sum(params["question_distribution"].values())
        )
    ...
    def _generate_ai_questions(
        self, chapter, learning_context, adaptive_params, num_questions, session_type
    ):
        """
        ...
        try:
            ...
            ai_context = self._prepare_ai_context(
                chapter, learning_context, adaptive_params
            )
            ...
            for question in questions:
                question["adaptive_metadata"] = {
                    ...
                    "based_on_performance": learning_context.get(
            ...
            return self._generate_fallback_questions(
                chapter, num_questions, adaptive_params
            )
    ...
    def _prepare_ai_context(self, chapter, learning_context, adaptive_params):
        ...
        return {
            ...
            "learning_patterns": {
                ...
                "previous_performance": learning_context.get(
                    "previous_chapters_performance", []
                ),
            },
    ...
    def _calculate_learning_velocity(self, user_id):
        ...
        try:
            ...
            recent_sessions = (
                PracticeSession.query.filter_by(user_id=user_id, is_completed=True)
                .filter(
    ...
    def analyze_practice_session(self, session_id):
        ...
        try:
            ...
            analysis["recommendations"] = self._generate_practice_recommendations(
                session, analysis
            )
    ...
    def _generate_practice_recommendations(self, session, analysis):
        ...
        weak_skills = [
            skill
            for skill, data in analysis["skill_progress"].items()
