...
class LLMConfig:
    ...
    def generate_text(
        ...
        try:
            if provider == LLMProvider.GEMINI:
                return cls._gemini_generate_text(prompt, temperature, max_tokens, system_prompt, json_mode)
            elif provider == LLMProvider.CUSTOM:
                return cls._custom_generate_text(prompt, temperature, max_tokens, system_prompt)
            else:
                return {
                    'success': False,
    ...
    def analyze_image(
        ...
        try:
            if provider == LLMProvider.GEMINI:
                return cls._gemini_analyze_image(image, prompt, temperature, max_tokens, json_mode)
            elif provider == LLMProvider.CUSTOM:
    ...
    @classmethod
    def _custom_generate_speech(cls, text: str, language: str, voice: str) -> Dict[str, Any]:
