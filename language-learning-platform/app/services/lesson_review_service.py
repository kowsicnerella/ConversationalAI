...
class LessonReviewService:
    ...
    def generate_lesson_review(
        self, user_id: int, activity_log_id: int, learning_path_id: Optional[int] = None
    ) -> Dict:
        """
        ...
        try:
            ...
            recent_scores = [
                log.score for log in recent_activities if log.score is not None
            ]
            avg_recent_score = (
            ...
            **Important Guidelines:**
            ...
            lesson_review = LessonReview(
                ...
                next_lesson_recommendation=review_data.get(
                    "next_lesson_recommendation", {}
                ),
                difficulty_adjustment=review_data.get(
            ...
            self._update_mastery_metrics(
                user_id, activity_type, score, review_data.get("focus_areas", [])
            )
            ...
            return {
                ...
                "telugu_motivational_message": review_data.get(
                    "telugu_motivational_message", ""
                ),
                "estimated_time_to_mastery": review_data.get(
    ...
    def _update_mastery_metrics(
        self, user_id: int, activity_type: str, score: float, focus_areas: List[str]
    ):
        ...
        try:
            ...
            mastery_metrics["overall"] = (
                round(sum(skill_values) / len(skill_values), 2) if skill_values else 0
            )
