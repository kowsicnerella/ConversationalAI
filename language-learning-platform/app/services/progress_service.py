...
class ProgressService:
    ...
    def update_user_activity_log(
        ...
        try:
            ...
            existing_log = (
                ...
                .order_by(UserActivityLog.attempt_number.desc())
                .first()
            )
    ...
    def get_learning_path_progress(self, user_id, path_id):
        ...
        try:
            ...
            completed_activity_ids = (
                db.session.query(UserActivityLog.activity_id)
                .filter(
    ...
    def get_user_profile(self, user_id):
        ...
        try:
            ...
            return {
                ...
                "last_activity_date": (
                    profile.last_activity_date.isoformat()
                    if profile.last_activity_date
                    else None
                ),
                ...
                history.append(
                    {
                        ...
                        "percentage": (
                            round((log.score / log.max_score) * 100, 2)
                            if log.max_score > 0
                            else 0
                        ),
    ...
    def create_learning_path(
        self, user_id, title, description, difficulty_level="beginner"
    ):
        """
        ...
        try:
            ...
            learning_path = LearningPath(
                title=title, description=description, difficulty_level=difficulty_level
            )
