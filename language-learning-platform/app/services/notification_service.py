...
from app.models import (
    db, User, Notification, NotificationType, UserNotificationSettings,
    LearningStreak, UserBadge, UserEnrollment, ChapterProgress
)
...
class NotificationService:
    ...
    def update_user_settings(user_id, settings_data):
        ...
        try:
            ...
            # Update settings
            updatable_fields = [
                'daily_reminder_enabled', 'daily_reminder_time', 'timezone',
                'streak_alerts', 'achievement_notifications', 'new_content_notifications',
                'personalized_tips', 'learning_path_updates',
                'in_app_notifications', 'email_notifications', 'push_notifications',
                'quiet_hours_start', 'quiet_hours_end', 'weekend_reminders'
            ]
            ...
            for field in updatable_fields:
                if field in settings_data:
                    ...
                    if field in ['daily_reminder_time', 'quiet_hours_start', 'quiet_hours_end']:
    ...
    def create_notification(user_id, notification_type, title, message, 
                          action_url=None, action_text=None, data=None, priority='normal'):
        """
        ...
        try:
            ...
            notif_type = NotificationType.query.filter_by(name=notification_type).first()
    ...
    def send_daily_reminder(user_id):
        ...
        try:
            ...
            message = f"Your {streak_days}-day streak is waiting! Keep up the great work!"
            
            if streak_days == 0:
                message = "Start your learning journey today! Practice makes perfect. 🌟"
            elif streak_days >= 7:
