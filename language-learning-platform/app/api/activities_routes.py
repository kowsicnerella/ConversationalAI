    ...
    try:
        ...
        if 'error' in flashcard_data:
            return jsonify({
                ...
                'message': flashcard_data.get('message', 'Failed to generate AI content. Please try again.')
            }), 500
    ...
    try:
        ...
        if 'error' in prompt_data:
            return jsonify({
                ...
                'message': prompt_data.get('message', 'Failed to generate AI content. Please try again.')
            }), 500
...
def submit_activity():
    ...
    try:
        ...
        if session:
            ...
            session.score = evaluation_result.get('overall_score') or evaluation_result.get('score_percentage', 0)
            ...
            if activity_type == 'quiz':
                ...
                correct_answers = sum(1 for item in evaluation_result.get('details', []) 
...
def get_activity_history():
    ...
    try:
        ...
        # Get recent sessions
        sessions = query.order_by(LearningSession.completed_at.desc()).limit(limit).all()
    ...
    try:
        ...
        if 'error' in scenario_data:
            return jsonify({
                ...
                'message': scenario_data.get('message', 'Failed to generate AI content. Please try again.')
            }), 500
    ...
    try:
        ...
        if 'error' in response_data:
            return jsonify({
                ...
                'message': response_data.get('message', 'Failed to generate AI response.')
            }), 500
    ...
    try:
        ...
        if 'error' in evaluation:
            return jsonify({
                ...
                'message': evaluation.get('message', 'Failed to evaluate session.')
            }), 500
