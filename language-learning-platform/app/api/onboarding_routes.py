...
def get_onboarding_status():
    ...
    try:
        ...
        if user.initial_assessment_id:
            initial_assessment = ProficiencyAssessment.query.get(
                user.initial_assessment_id
            )
            ...
            jsonify(
                {
                    ...
                    "onboarding_status": {
                        ...
                        "assessment": (
                            {
                                ...
                                "completed": (
                                    initial_assessment.completed_at is not None
                                    if initial_assessment
                                    else False
                                ),
                                "assessment_id": user.initial_assessment_id,
                                "proficiency_level": (
                                    initial_assessment.proficiency_level
                                    if initial_assessment
                                    else None
                                ),
                            }
                        ...
                        "profile": {
                            ...
                            "mastery_metrics": (
                                profile.mastery_metrics if profile else {}
                            ),
                        },
                    },
                }
            ...
            jsonify(
                {
                    ...
                    "updated_status": {
                        ...
                        "current_learning_phase": user.current_learning_phase,
                        "assessment_taken_at": (
                            user.assessment_taken_at.isoformat()
                            if user.assessment_taken_at
                            else None
                        ),
                    },
                }
...
def get_progress_snapshot():
    ...
    try:
        ...
        recent_milestones = (
            Milestone.query.filter_by(user_id=user_id)
